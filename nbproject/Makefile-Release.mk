...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/revisedsource: ${OBJECTFILES}
	...
	${LINK.cc} -L/Users/kaiwu/Downloads/root/lib -lCore -lCint -lRIO -lNet -lHist -lGraf -lGraf3d -lGpad -lTree -lRint -lPostscript -lMatrix -lPhysics -lMathCore -lThread -lpthread -Wl,-rpath,/Users/kaiwu/Downloads/root/lib -lm -ldl -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/revisedsource ${OBJECTFILES} ${LDLIBSOPTIONS} 
